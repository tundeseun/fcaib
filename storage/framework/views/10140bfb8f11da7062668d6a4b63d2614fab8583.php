                        ...
                        <div class="in_login_page_iner">
                            <form method="POST" class="loginForm" action="<?php echo e(route('login')); ?>" id="infix_form">
                                ...
                                <div class="create_account text-center">
                                    <p>New Student? <a href="<?php echo e(url('parentregistration/registration')); ?>">Enrol Here</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\college\resources\views/auth/loginCodeCanyon.blade.php ENDPATH**/ ?>