...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
            <div class="row mb-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-end">
                    <a  class="btn small btn-outline-secondary mr-2" type="button" data-toggle="modal" data-target="#exampleModal">
                        Promote All Students
                    </a>
                    <a  class="btn btn-primary" href="student-admission">
                        Add Students
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3" id="sectionStudentDiv">
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                By promoting all students, you will end the current session and a new session will be started with all students in the next level
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
              <a type="button" class="btn btn-primary" href="<?php echo e(route('promote-all-students')); ?>">Promote All Students</a>
            </div>
          </div>
        </div>
      </div>
   ...
   $(document).ready(function() {
       $('.data-table').DataTable({
                     ...
                     "ajax": $.fn.dataTable.pipeline( {
                       ...
                       columns: [
                           {data: 'matric_number', name: 'matric_number'},
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/studentInformation/student_details.blade.php ENDPATH**/ ?>