                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <?php echo app('translator')->get('lang.password_reset_message'); ?> 
                                    </td>
                                </tr>
                                <tr>
                                    <td height="50"><img
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:14px 30px 14px 30px;text-transform:uppercase; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align:center; font-size: 14px; font-weight:bold; line-height: 1.3; color:#ffffff;">
                                                                            <a href="<?php echo e(url('reset/password'.'/'.$data['email'].'/'.$data['random'])); ?>"
                                                                               ...
                                                                               target="_blank"> <?php echo app('translator')->get('lang.click_here'); ?></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
...
</html><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/auth/confirmation_reset.blade.php ENDPATH**/ ?>