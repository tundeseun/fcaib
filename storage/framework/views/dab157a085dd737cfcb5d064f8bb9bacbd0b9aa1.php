        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php endif; ?>
                    <div class="white-box">
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'parentregistration/student-list', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'parent-registration'])); ?>
                            ...
                            <table id="table_id" class="" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(@$student->class->class_name); ?><td><?php echo e(@$student->class->class_name); ?>(<?php echo e(@$student->section->section_name); ?>)</td></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('parentregistration/student-view', [$student->id])); ?>"  data-id="<?php echo e($student->id); ?>"  ><?php echo app('translator')->get('lang.view'); ?></a>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\college\Modules/ParentRegistration\Resources/views/students.blade.php ENDPATH**/ ?>