										...
										<tbody>
											...
											<tr>
												<td align="center" style="font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; font-weight:normal; color:#24252a; line-height:22px; text-align:left; display:block;">
													...
													<h3>Dear <?php echo e($compact['name']); ?>,</h3>
													<p>Congratulations, <?php echo e(generalSetting()->school_name); ?> is pleased to inform you that after reviewing your application to study with us you have been granted provisional admission.</p>

													<p>Please login using this username <?php echo e($compact['email']); ?> and password <?php echo e($compact['password']); ?> to print your admission letter and begin your clearance.</p>
																			...
																			<table cellspacing="0" cellpadding="0" border="0" width="100%">
																				<tr>
																					<td style="padding:14px 30px 14px 30px;text-transform:uppercase; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align:center; font-size: 14px; font-weight:bold; line-height: 1.3; color:#ffffff;">
																						<a href="<?php echo e(url('/login')); ?>" style="color:#ffffff; text-decoration:none; margin-bottom: 10px;" target="_blank">Login </a>
...
</html><?php /**PATH C:\xampp\htdocs\college\resources\views/modules/parentregistration/approve_email.blade.php ENDPATH**/ ?>