                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('name') ||  session()->has('message-exist')? ' is-invalid' : ''); ?>" name="name" id="name">
                                                <option value="">Fee</option>
                                                <?php $__currentLoopData = $remitaFees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $remitaFee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($key); ?>" <?php echo e($key == @$fees_type->remita_service_id ? 'selected':''); ?> ><?php echo e($remitaFee); ?> </option>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               ...
                                               <?php if(userPermission(130)): ?>
                                                   <?php if($fees_type->id != 3 && $fees_type->id != 4 && $fees_type->id != 5): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/feesCollection/fees_type.blade.php ENDPATH**/ ?>