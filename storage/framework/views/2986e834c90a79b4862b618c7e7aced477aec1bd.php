...
<head>
    ...
    <title><?php echo app('translator')->get('lang.export_to_pdf'); ?></title>
    <style>
        body{
                                       ...
                                       <tbody>
                                           <tr>
                                               <td>
                                                <p class="line_grid" >
                                                    <span>
                                                        <span><?php echo app('translator')->get('lang.academic_year'); ?></span>
                                                        <span>:</span>
                                                    </span>
...
<?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/studentInformation/allStudentExportPdfPrint.blade.php ENDPATH**/ ?>