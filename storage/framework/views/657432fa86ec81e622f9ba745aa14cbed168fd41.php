                    ...
                    <div class="row mb-30 mt-20">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input form-control" cols="0" rows="4" name="current_address" id="current_address" value="<?php if(isset($editData)): ?><?php echo e($editData->current_address); ?><?php endif; ?>"/>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input form-control" cols="0" rows="4"  name="permanent_address" id="permanent_address" value="<?php if(isset($editData)): ?><?php echo e($editData->permanent_address); ?><?php endif; ?>"/>
                                        <span class="focus-border textarea"></span>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/humanResource/editStaff.blade.php ENDPATH**/ ?>