...
<?php echo app('translator')->get('lang.fees'); ?> <?php echo app('translator')->get('lang.invoice'); ?> <?php echo app('translator')->get('lang.bulk'); ?> <?php echo app('translator')->get('lang.print'); ?>
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.fees'); ?> <?php echo app('translator')->get('lang.invoice'); ?> <?php echo app('translator')->get('lang.bulk'); ?> <?php echo app('translator')->get('lang.print'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(route('dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.fees_collection'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.report'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.fees'); ?> <?php echo app('translator')->get('lang.invoice'); ?> <?php echo app('translator')->get('lang.bulk'); ?> <?php echo app('translator')->get('lang.print'); ?></a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/Modules/BulkPrint/Resources/views/feesCollection/fees_bulk_print.blade.php ENDPATH**/ ?>