                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('fees_receipt', [$fees_payment->id, $id])); ?>" class="btn btn-sm btn-success"><span class="ti-printer"></span> Receipt</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\infix\resources\views/backEnd/studentPanel/paid_fees.blade.php ENDPATH**/ ?>