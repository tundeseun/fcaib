        ...
        <div class="row mt-20">
            <div class="col-lg-12">
                <div class="white-box single_registration_area">
                 ...
                 <?php else: ?>   
                    <form method="POST" class="" action="<?php echo e(route('statement-result-2')); ?>" id="parent-registration" enctype="multipart/form-data">
                        <div class="row">
                                <div class="reg_tittle col-md-6 offset-md-3 mb-20">
                                    <h2 class="text-center">Statement of Result Application Form</h2>
                                    <p class="text-center text-danger">Note: Statement of Result application & processing costs <?php echo e(@generalSetting()->currency_symbol); ?><?php echo e(number_format($application_cost)); ?> Please fill all fields & click apply to continue*</p>
                                </div>
                        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/studentPanel/statement_result.blade.php ENDPATH**/ ?>