										...
										<tbody>
											...
											<tr>
												<td align="center" class="m_img_mc_fix">
													<img align="center" src="<?php echo e(asset(generalSetting()->logo)); ?>" alt="" width="83" height="83" border="0" style="width:83px; max-width:83px;">
												</td>
										...
										<tbody>
											...
											<tr>
												<td align="center" style="font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; font-weight:normal; color:#24252a; line-height:22px; text-align:left; display:block;">
													...
													<h3>Dear <?php echo e($applicant_details['fullname']); ?>,</h3>
													<p>Congratulations, <b><?php echo e(@generalSetting()->school_name); ?></b> is pleased to inform you that after reviewing your application to study with us you have been granted provisional admission.</p>

													<p>Please login using this username <b><?php echo e($applicant_details['email']); ?></b> and password <b>123456</b> to print your admission letter and begin your clearance.</p>
													...
													Regards,<br/>
													<?php echo e(@generalSetting()->school_name); ?> admission office.<br/>
																			...
																			<table cellspacing="0" cellpadding="0" border="0" width="100%">
																				<tr>
																					<td style="padding:14px 30px 14px 30px;text-transform:uppercase; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align:center; font-size: 14px; font-weight:bold; line-height: 1.3; color:#ffffff;">
																						<a href="<?php echo e(url('/login')); ?>" style="color:#ffffff; text-decoration:none; margin-bottom: 10px; background: #AD36E6; border: none; height: 40px; padding: 10px;" target="_blank" >Login </a>
...
</html><?php /**PATH C:\xampp\htdocs\infix\resources\views/modules/parentregistration/approve_email.blade.php ENDPATH**/ ?>