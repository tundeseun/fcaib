<?php if(in_array(561, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 ): ?>
<div class="col-lg-3">
    ...
    <div class="main-title">
        <h3 class="mb-30">
            ...
            <?php endif; ?>
            <?php echo app('translator')->get('lang.meeting'); ?>
        </h3>
    </div>

    <?php if(isset($editdata)): ?>
        <form class="form-horizontal" action="<?php echo e(route('zoom.meetings.update',$editdata->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
    <?php else: ?>
        <?php if(userPermission(556)): ?>
            <form class="form-horizontal" action="<?php echo e(route('zoom.meetings.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
        <?php endif; ?>
    <?php endif; ?>
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    <div class="row mb-30">
                        <div class="col-lg-12 ">
                            <select class="niceSelect w-100 bb user_type form-control<?php echo e($errors->has('user_type') ? ' is-invalid' : ''); ?>" name="member_type">
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(isset($editdata)): ?>
                                        <option value="<?php echo e($value->id); ?>" <?php echo e($value->id == $user_type ? 'selected' : ''); ?>><?php echo e($value->name); ?></option>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12" id="selectTeacherDiv">
                            <label for="checkbox" class="mb-2"><?php echo app('translator')->get('lang.member'); ?> *</label>
                                <select multiple id="selectSectionss" <?php echo e(@$errors->has('participate_ids') ? ' is-invalid' : ''); ?> name="participate_ids[]" style="width:300px">
                                    <?php if(isset($editdata)): ?>
                                        <?php $__currentLoopData = $userList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($value->id); ?>"  selected ><?php echo e($value->full_name); ?></option>
                                            
                                        
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </select>
                                <?php if($errors->has('participate_ids')): ?>
                                    <span class="invalid-feedback" role="alert" style="display:block">
                                        <strong><?php echo e($errors->first('participate_ids')); ?></strong>
                                    </span>
                                <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-6">
                                <label><?php echo app('translator')->get('lang.date_of_meeting'); ?><span>*</span></label>
                            ...
                            <div class="col-lg-6">
                                    <label><?php echo app('translator')->get('lang.time_of_meeting'); ?><span>*</span></label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    <input  type="number" oninput="numberCheck(this)" class="primary-input form-control<?php echo e($errors->has('durration') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <label><?php echo app('translator')->get('lang.meeting_durration'); ?><span>*</span></label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    <input type="number"  oninput="numberCheck(this)" class="primary-input form-control<?php echo e($errors->has('time_start_before') ? ' is-invalid' : ''); ?>"
                                    type="text" name="time_start_before" autocomplete="off" value="<?php echo e(isset($editdata)? old('time_start_before',$editdata->time_before_start) : 10); ?>">
                                    <label><?php echo app('translator')->get('lang.meeting'); ?> <?php echo app('translator')->get('lang.start'); ?> <?php echo app('translator')->get('lang.before'); ?></label>
                                    <span class="focus-border"></span>
                                    <?php if($errors->has('time_start_before')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('time_start_before')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH /home2/fcaibedu/public_html/portal/Modules/Zoom/Resources/views/meeting/includes/form.blade.php ENDPATH**/ ?>