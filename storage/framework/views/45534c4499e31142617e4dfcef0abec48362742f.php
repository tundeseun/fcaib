                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row  mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input oninput="numberCheck(this)" class="primary-input form-control<?php echo e($errors->has('cost') ? ' is-invalid' : ''); ?>" type="text" name="cost" 
                                            value="<?php echo e(isset($dormitory_list)? $dormitory_list->cost: old('cost')); ?>">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               ...
                                               <?php if(userPermission(370)): ?>
                                                ...
                                                <?php endif; ?>
                                                <a class="dropdown-item" href="<?php echo e(route('room-lists', [$dormitory_list->id])); ?>">Rooms</a>
                                                </div>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/dormitory/dormitory_list.blade.php ENDPATH**/ ?>