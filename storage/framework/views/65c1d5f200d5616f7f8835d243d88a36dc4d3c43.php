										...
										<tbody>
											...
											<tr>
												<td align="center" style="font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; font-weight:normal; color:#24252a; line-height:22px; text-align:left; display:block;">
													...
													<p>Your profile has been created on <?php echo e(generalSetting()->school_name); ?> online portal</p>

													<p>Please login using this username <?php echo e($compact['email']); ?> and password <?php echo e($compact['password']); ?></p>

													<p>Do not share your login details with anyone</p>


													Regards,<br/>
													<?php echo e(generalSetting()->school_name); ?><br/>
...
</html><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/studentInformation/user_credential.blade.php ENDPATH**/ ?>