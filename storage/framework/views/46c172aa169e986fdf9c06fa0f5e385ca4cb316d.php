										...
										<tbody>
											...
											<tr>
												<td align="center" class="m_img_mc_fix">
													<center><img align="center" src="<?php echo e(asset(generalSetting()->logo)); ?>" alt="" width="83" height="83" border="0" style="width:100px; max-width:100px;"></center>
												</td>
										...
										<tbody>
											...
											<tr>
												<td align="center" style="font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:15px; font-weight:normal; color:#24252a; line-height:22px; text-align:left; display:block;">
													<p><?php echo e(@date('F Y')); ?></p>
													<p>Dear <?php echo e(@$compact['name']); ?>,</p>
...
</html><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/modules/parentregistration/admission_letter.blade.php ENDPATH**/ ?>