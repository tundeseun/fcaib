                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-30"><?php if(isset($classById)): ?>
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-30">
                                        <div class="col-lg-12">
                                            <select class="w-100 bb niceSelect form-control <?php echo e($errors->has('hod') ? ' is-invalid' : ''); ?>" name="hod">
                                                <option data-display="Select Head of Dept. *" value="">Select Head of Dept. *</option>
                                                <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($teacher->id); ?>" <?php echo e(isset($classById) ? ($classById->hod == $teacher->id ? 'selected':''):''); ?> ><?php echo e(@$teacher->full_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <?php if($errors->has('hod')): ?>
                                            <span class="invalid-feedback invalid-select" role="alert">
                                                <strong><?php echo e(@$errors->first('hod')); ?></strong>
                                            </span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(@$class->full_name); ?></td>
                                        <td>
                                        ...
                                        <td><?php echo e(getStudentsByDept($class->id)); ?></td>
                                        <td valign="top">
                                            <div class="dropdown">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/academics/class.blade.php ENDPATH**/ ?>