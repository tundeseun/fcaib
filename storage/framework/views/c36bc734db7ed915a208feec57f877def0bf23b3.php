                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php if($online_exam->status == 0): ?>
                                                    <a class="ml-3" href="<?php echo e(route('online_exam_publish', [$online_exam->id])); ?>">
                                                        <button class="primary-btn small bg-success text-white border-0">Publish </button>
                                                    </a> 
                                                <?php endif; ?>
                                             <?php endif; ?>
                                        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/examination/online_exam.blade.php ENDPATH**/ ?>