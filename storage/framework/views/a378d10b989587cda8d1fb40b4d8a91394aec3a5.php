...
<nav id="sidebar">
    ...
    <?php if(Auth::user()->is_saas == 0): ?>
        ...
        <ul class="list-unstyled components" id="sidebar_menu">
            ...
            <?php if(Auth::user()->role_id == 4 && Auth::user()->isHOD()): ?>
                    <li >
                            ...
                            <ul class="collapse list-unstyled" id="subMenuHOD">
                                    <li >
                                        <a href="<?php echo e(route('department-results')); ?>">Pending Dept. Results</a>
                                    </li>
                                    <li >
                                        <a href="<?php echo e(route('accepted-department-results')); ?>">Accepted Dept. Results</a>
                                    </li>
                                    <li >
                                        <a href="<?php echo e(route('rejected-department-results')); ?>">Rejected Dept. Results</a>
                                    </li>
                            </ul>
                    </li>
            <?php endif; ?>
                    ...
                    <?php if(userPermission(245)  ): ?>
                        <li  >
                            ...
                            <ul class="collapse list-unstyled" id="subMenuAcademic">
                                <li>
                                    <a href="<?php echo e(route('upload-results')); ?>">Bulk Result Upload</a>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('upload-graduands')); ?>">Upload Graduands List</a>
                                </li>
...
</nav><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/partials/sidebar.blade.php ENDPATH**/ ?>