                ...
                <div class="col-sm-8 col-lg-5 col-xl-4 col-md-7">
                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            ...
                            <form method="POST" class="loginForm" action="<?php echo e(route('pay-with-paystack')); ?>" >
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="<?php echo app('translator')->get('lang.enter'); ?> UTME Number" name="utme_number" class="<?php echo e($errors->has('utme_number') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('utme_number') ?? $utme_number); ?>" id="utme-number">
                                ...
                                <input type="hidden" name="payment_type" value="Post UTME Fee">
                                ...
                                <div class="in_login_button text-center mt-2">
                                    <button type="submit" class="btn btn-warning form-control" >
                                        Pay <?php echo e(@generalSetting()->currency_symbol); ?><?php echo e(number_format($application_cost->amount)); ?>
...
<?php /**PATH C:\xampp\htdocs\infix\resources\views/auth/studentRegistration.blade.php ENDPATH**/ ?>