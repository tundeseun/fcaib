            ...
            <div class="row align-items-center">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="contact_info">
                        <div class="info_item">
                            <i class="ti-home"></i>
                            <h6><?php echo e(generalSetting()->address); ?></h6>
                           
                        </div>
                        <div class="info_item">
                            <i class="ti-headphone-alt"></i>
                            <h6><a href="#"><?php echo e(generalSetting()->phone); ?></a></h6>
                            <p><?php echo e($contact_info->phone_text); ?></p>
                        </div>
                        <div class="info_item">
                            <i class="ti-email"></i>
                            <h6>
                                <a href="#"><?php echo e(generalSetting()->email); ?></a>
                            </h6>
...
<?php echo $__env->make('frontEnd.home.front_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\infix\resources\views/frontEnd/home/light_contact.blade.php ENDPATH**/ ?>