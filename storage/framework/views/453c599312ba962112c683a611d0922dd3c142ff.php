                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class=" bg-white p-3">
                                <div width="100%">
                                    <h3><big>Exam Attendance Sheet</big><br/>Department: <?php echo e($class_name); ?><br/>Course: <?php echo e($subject->subject_name); ?><br/>Course Code: <?php echo e(strtoupper($subject->subject_code)); ?><br/>Level: <?php echo e($section_name); ?></h3>
                                </div>
                                <table class="table" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border p-3"><?php echo e(@$student->matric_number!=""?@$student->matric_number:""); ?><input type="hidden" name="id[]" value="<?php echo e(@$student->student_id); ?>"></td>
                                            <td class="border p-3"><img src="<?php echo e(@$student->student_photo); ?>" width="80px" height="80px"></td>
                                            <td class="border p-3"><?php echo e(ucwords($student->first_name.' '.@$student->last_name)); ?></td>
                                            <td class="border p-3">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\infix\resources\views/backEnd/examination/exam_attendance.blade.php ENDPATH**/ ?>