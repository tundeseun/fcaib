                            ...
                            <table id="table_ids" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo e(route('student-result', [@$student->id])); ?>" class="primary-btn small fix-gr-bg">Results</a></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/studentInformation/student_history.blade.php ENDPATH**/ ?>