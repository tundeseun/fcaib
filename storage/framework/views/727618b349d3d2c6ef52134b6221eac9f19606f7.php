            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3>Lecturers</h3>
                            <p class="mb-0"><?php echo app('translator')->get('lang.total'); ?> Lecturers</p>
                        </div>
                        <h1 class="gradient-color2">
                            <?php if(isset($totalStudents)): ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\college\resources\views/backEnd/dashboard.blade.php ENDPATH**/ ?>