                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> 
                                                ...
                                                <a  class="primary-btn small tr-bg" href="#"> <?php echo app('translator')->get('lang.default'); ?></a> 
                                                </span>
                                                <?php endif; ?>
                                            <?php else: ?>
                                            <?php if(userPermission(489)): ?>
                                            <a  class="primary-btn small tr-bg" href="<?php echo e(route('background_setting-status',@$background_setting->id)); ?>"><?php echo app('translator')->get('lang.default'); ?></a> 
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/systemSettings/background_setting.blade.php ENDPATH**/ ?>