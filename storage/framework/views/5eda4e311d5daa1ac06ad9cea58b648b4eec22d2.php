    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-12">
                ...
                <?php else: ?>
                    <h3 class="mb-0"><?php echo app('translator')->get('lang.welcome'); ?> -  <?php echo e(@Auth::user()->roles->name); ?></h3>
                <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery" style="background: #B5D56A;">
                    <div class="d-flex justify-content-between" >
                        <div>
                            <h3 class="text-white"><?php echo app('translator')->get('lang.student'); ?></h3>
                            <p class="mb-0 text-white"><?php echo app('translator')->get('lang.total'); ?> <?php echo app('translator')->get('lang.students'); ?></p>
                        </div>
                        <h1 class="text-white">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery" style="background: #4886FF;">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="text-white">Lecturers</h3>
                            <p class="mb-0 text-white"><?php echo app('translator')->get('lang.total'); ?> Lecturers</p>
                        </div>
                        <h1 class="text-white">
                            <?php if(isset($totalStudents)): ?>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery" style="background: #F6316F;">
                    <div class="d-flex justify-content-between" >
                        <div>
                            <h3 class="text-white"><?php echo app('translator')->get('lang.staffs'); ?></h3>
                            <p class="mb-0 text-white"><?php echo app('translator')->get('lang.total'); ?> <?php echo app('translator')->get('lang.staffs'); ?></p>
                        </div>
                        <h1 class="text-white">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery" style="background: #B5D56A; color: #ffffff;">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3 class="text-white"><?php echo app('translator')->get('lang.student'); ?></h3>
                            <p class="mb-0 text-white"><?php echo app('translator')->get('lang.total'); ?> <?php echo app('translator')->get('lang.students'); ?></p>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/dashboard.blade.php ENDPATH**/ ?>