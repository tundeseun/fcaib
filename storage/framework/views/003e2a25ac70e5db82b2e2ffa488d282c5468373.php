        ...
        <div class="row mt-20">
            <div class="col-lg-12">
                ...
                <?php if($has_application == 1): ?>
                 ...
                 <?php else: ?>
                    <form method="POST" class="" action="<?php echo e(route('transcript-application-2')); ?>" id="parent-registration" enctype="multipart/form-data">
                        <div class="row">
                                <div class="reg_tittle col-md-6 offset-md-3 mb-20">
                                    <h2 class="text-center">Transcript Application Form</h2>
                                    <p class="text-center text-danger">Note: Transcript application & processing costs <?php echo e(@generalSetting()->currency_symbol); ?><?php echo e(number_format($transcript_cost)); ?> Please fill all fields & click apply to continue*</p>
                                </div>
                        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/studentPanel/transcript_application.blade.php ENDPATH**/ ?>