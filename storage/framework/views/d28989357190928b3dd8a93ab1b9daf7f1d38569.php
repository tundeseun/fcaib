...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="offset-lg-3 col-lg-3 text-right mb-20">
                <a href="<?php echo e(url('/public/backEnd/bulksample/results.xlsx')); ?>">
    ...
    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'upload-result-store',
                    ...
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-4" id="class-div">
                                <select class="w-100 niceSelect bb form-control <?php echo e($errors->has('course') ? ' is-invalid' : ''); ?>" name="course" required>
                                    <option data-display="Course *" value="">Course *</option>
                                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php echo e($course->id == request()->id ? 'selected readonly' : ''); ?> title="<?php echo e($course->subject_name); ?>" value="<?php echo e($course->id); ?>"><?php echo e($course->subject_name); ?></option>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fcaibedu/public_html/portal/resources/views/backEnd/studentPanel/upload_results.blade.php ENDPATH**/ ?>