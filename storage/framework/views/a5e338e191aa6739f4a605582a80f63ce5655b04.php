                    ...
                    <div class="text-center white-box single_registration_area">
                        <form method="POST" class="" action="<?php echo e(route('parentregistration-student-store')); ?>" id="parent-registration" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="reg_tittle mt-20 mb-20">
                                        <h1>
                                            <b><?php echo e($setting->school_name); ?></b>
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="academic_year" value="<?php echo e($setting->academic_id); ?>">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="form-control" type="email" name='student_email' id="student_email" placeholder="<?php echo app('translator')->get('lang.student'); ?> <?php echo app('translator')->get('lang.email'); ?>*" value="<?php echo e($email); ?>" readonly />
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="form-control" type="text" name='utme_number' placeholder="UTME (J.A.M.B) Registration Number *" value="<?php echo e($utme_number); ?>" readonly />
                                    </div>
                                    <?php if($errors->has('utme_number')): ?>
                                    <div class="text-danger error-message invalid-select mb-10"><?php echo e($errors->first('utme_number')); ?></div>
                                    <?php endif; ?>
                                </div>
                                
                                <div class="col-lg-6">
                                    <div class="form-group input-group">
                                        <input class="form-control" type="number" name='utme_score' placeholder="UTME (J.A.M.B) Score *" value="<?php echo e(old('utme_score')); ?>" />
                                    </div>
                                    <?php if($errors->has('utme_score')): ?>
                                            <div class="text-danger error-message invalid-select mb-10"><?php echo e($errors->first('utme_score')); ?></div>
                                        <?php endif; ?>
                                </div>
                            </div>
...
<?php /**PATH /home2/fcaibedu/public_html/portal/Modules/ParentRegistration/Resources/views/registration.blade.php ENDPATH**/ ?>