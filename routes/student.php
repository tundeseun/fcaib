...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        Route::get('pay-fees/{id}', ['uses' => 'Student\SmFeesController@payFees'])->middleware('userRolePermission:20');
        ...
        //course registration
        Route::get('course-registration', ['as' => 'course-registration', 'uses' => 'Student\SmStudentPanelController@courseRegistration'])->middleware('userRolePermission:49');
        Route::post('course-registration', ['as' => 'course-registration', 'uses' => 'Student\SmStudentPanelController@courseRegistrationStore']);
        ...
        Route::get('student-dormitory/booking/{paymentReference}/{transactionId}', ['uses' => 'Student\SmStudentPanelController@studentDormitoryBooking']);
        Route::get('student-dormitory/room-allocation/{roomId}', ['uses' => 'Student\SmStudentPanelController@studentRoomAllocation']);
        Route::get('student-dormitory/cancel', ['uses' => 'Student\SmStudentPanelController@cancelBooking']);
        Route::get('student-dormitory/allocation/{paymentReference}/{transactionId}', ['uses' => 'Student\SmStudentPanelController@studentAllocateRoom']);
...
Route::get('student-result/{id}', 'Student\SmStudentPanelController@studentResult')->name('student-result');
Route::get('transcript-application', 'Student\SmStudentPanelController@transcriptApplication')->name('transcript-application');
Route::post('transcript-application-2', 'Student\SmStudentPanelController@transcriptApplicationTwo')->name('transcript-application-2');
Route::get('transcript-application-3/{paymentReference}/{transactionId}', 'Student\SmStudentPanelController@transcriptApplicationThree')->name('transcript-application-3');

Route::get('statement-result', 'Student\SmStudentPanelController@statementResult')->name('statement-result');
Route::post('statement-result-2', 'Student\SmStudentPanelController@statementResultTwo')->name('statement-result-2');
Route::get('statement-result-3/{paymentReference}/{transactionId}', 'Student\SmStudentPanelController@statementResultThree')->name('statement-result-3');

Route::get('pay-fees-2/{paymentReference}/{transactionId}/{id}', 'Student\SmStudentPanelController@payFeesTwo')->name('pay-fees-2');

Route::get('student-paid-fees/{id}', ['as' => 'student_paid_fees', 'uses' => 'Student\SmFeesController@studentPaidFees']);
Route::get('fees-receipt/{id}/{sid}', ['as' => 'fees_receipt', 'uses' => 'Student\SmFeesController@FeesReceipt']);