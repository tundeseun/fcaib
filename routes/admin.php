...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('add-course', 'SmSubjectController@create')->middleware('userRolePermission:258');
        //Class Routine
        ...
        //upload result
        Route::get('course-list', 'teacher\TeacherContentController@courseList')->name('course-list');
        Route::get('upload-results/{id}', 'teacher\TeacherContentController@uploadResults')->name('upload-results');
        Route::post('update-score', 'teacher\TeacherContentController@updateScore')->name('update-score');
        Route::get('lecturer-online-exam-results','teacher\TeacherContentController@onlineExamResults')->name('lecturer-online-exam-results');
        Route::get('department-results', 'teacher\TeacherContentController@departmentResults')->name('department-results');
        Route::get('accepted-department-results', 'teacher\TeacherContentController@acceptedDepartmentResults')->name('accepted-department-results');
        Route::get('rejected-department-results', 'teacher\TeacherContentController@rejectedDepartmentResults')->name('rejected-department-results');
        Route::get('upload-results-single/{id}', 'teacher\TeacherContentController@uploadResultsSingle')->name('upload-results-single');
        Route::get('department-result-accept/{id}','teacher\TeacherContentController@acceptResult')->name('department-result-accept');
        Route::get('department-result-reject/{id}','teacher\TeacherContentController@rejectResult')->name('department-result-reject');
...
// });
        ...
        Route::get('room-lists/{id}', 'SmRoomListController@index')->name('room-lists')->middleware('userRolePermission:363');
        ...
        Route::get('room-list-allocate/{id}', 'SmRoomListController@allocate')->name('room-list-allocate');
        Route::post('room-list-allocate/{id}', 'SmRoomListController@postAllocate')->name('room-list-allocate');
        ...
        Route::get('exam-schedule-create/{class_id}/{section_id}','SmExamRoutineController@examScheduleCreate')->name('exam_schedule_create');
        Route::get('delete-exam-schedule-modal/{id}', 'SmExamRoutineController@deleteExamScheduleModal')->name('delete-exam-schedule-modal')->middleware('userRolePermission:249');

        Route::get('delete-exam-schedule/{id}', 'SmExamRoutineController@deleteExamSchedule')->name('delete-exam-schedule')->middleware('userRolePermission:249');

        Route::post('add-new-exam-schedule', 'SmExamRoutineController@addNewExamSchedule')->name('add-new-exam-schedule');

        Route::get('edit-exam-schedule/{id}/{section_id}/{class_id}', 'SmExamRoutineController@editExamSchedule')->name('edit-exam-schedule')->middleware('userRolePermission:248');

        
        Route::post('update-exam-schedule', 'SmExamRoutineController@updateExamSchedule')->name('update-exam-schedule');
        ...
        Route::get('fees-assign-search', 'SmFeesMasterController@feesAssignSearch')->name('fees-assign-search');
        

        Route::post('fees-assign-store', 'SmFeesMasterController@feesAssignStore')->name('fees-assign-store');
        ...
        Route::post('add-document', ['as' => 'add-document', 'uses' => 'SmAcademicsController@addDocument']);
        Route::get('manage-documents', 'SmAcademicsController@manageDocuments')->name('manage-documents');
        ...
        Route::get('promote-all-students', ['as' => 'promote-all-students', 'uses' => 'SmStudentAdmissionController@promoteAllStudents']);
    ...
    //transcript
    Route::get('transcript-applications', 'SmStudentAdmissionController@transcriptApplications')->name('transcript-applications');
    Route::get('transcript-uapplications', 'SmStudentAdmissionController@transcriptUapplications')->name('transcript-uapplications');
    Route::get('transcript/{id}', 'SmStudentAdmissionController@transcriptSingle')->name('transcript');
    Route::get('transcript-treated/{id}', 'SmStudentAdmissionController@transcriptTreated')->name('transcript-treated');
    Route::get('transcript-untreated/{id}', 'SmStudentAdmissionController@transcriptUntreated')->name('transcript-untreated');
    Route::get('generate-transcript/{id}', 'SmStudentAdmissionController@generateTranscript')->name('generate-transcript');

    Route::get('statement-result-untreated', 'SmStudentAdmissionController@statementUntreated')->name('statement-result-untreated');
    Route::get('statement-result-treated', 'SmStudentAdmissionController@statementTreated')->name('statement-result-treated');
    Route::get('statement-m-untreated/{id}', 'SmStudentAdmissionController@statementMUntreated')->name('statement-m-untreated');
    Route::get('statement-m-treated/{id}', 'SmStudentAdmissionController@statementMTreated')->name('statement-m-treated');
    Route::get('upload-results/{id?}', 'SmStudentAdmissionController@uploadResults')->name('upload-results');
    Route::post('upload-result-store', 'SmStudentAdmissionController@uploadResultStore')->name('upload-result-store');

    Route::get('upload-graduands', 'SmStudentAdmissionController@uploadGraduands')->name('upload-graduands');
    Route::post('upload-graduands-store', 'SmStudentAdmissionController@uploadGraduandsStore')->name('upload-graduands-store');
