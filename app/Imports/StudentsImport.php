    ...
    */
    public function model(array $row)
    {
        return new StudentBulkTemporary([
          ...
          "date_of_birth" => \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject((int)@$row['date_of_birth'])->format('Y-m-d'),
          "religion" => @$row['religion'],
          "gender" => @$row['gender'],
          "mobile" => @$row['mobile'],
          "email" => @$row['email'],
          "admission_date" => \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject((int)@$row['admission_date'])->format('Y-m-d'),
