...
class SmSystemSettingController extends Controller
{
    ...
    public function updateGeneralSettingsData(Request $request)
    {
        ...
        $validator = Validator::make($input, [
            ...
            'hostel_booking' => "required",
            'course_registration' => "required",
            'hostel_booking_cost' => "required"
        ...
        try {
            ...
            $generalSettData->hostel_booking = $request->hostel_booking;
            $generalSettData->course_registration  = $request->course_registration;
            $generalSettData->hostel_booking_cost  = $request->hostel_booking_cost;
