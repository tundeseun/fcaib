...
//
    ...
    public function viewExamSchedule($class_id, $section_id, $exam_id)
    {
        try{
            ...
            $assign_subjects = SmExamScheduleSubject::where('exam_schedule_id', $exam_id)->where('school_id',Auth::user()->school_id)->get();
    ...
    public function viewExamStatus($exam_id)
    {
        try{
            ...
            $view_exams = SmExamSchedule::where('exam_id', $exam_id)->where('school_id',Auth::user()->school_id)->get();
   ...
   if ($is_duplicate) {
    ...
    public function marksRegisterSearch(Request $request)
    {
        ...
        try{
            ...
            $students = SmStudent::where('active_status', 1)->where('class_id', $request->class)->get();
            ...
            if ($students->count() < 1) {
                ...
                )->whereIn('section_id',$classSections)->groupby(['subject_id','exam_title'])->orderby('id','ASC')->get();
        ...
        if ($exam_attendance) {
         ...
         $students=$students->where('active_status', 1)->get();
            ...
            if ($students->count() == 0) {
                ...
                $marks_entry_form=$marks_entry_form->where('subject_id', $subject_id)->get();        
    ...
    public function seatPlanSearch(Request $request)
    {
       ...
       try{
            ...
            foreach ($class_rooms as $class_room) {
                $assigned_student = SmSeatPlanChild::where('room_id', $class_room->id)->where('school_id',Auth::user()->school_id)->get();
    ...
    public function seatPlanReportSearch(Request $request)
    {
      try{
            ...
            $seat_plans = $seat_plans->where('school_id',Auth::user()->school_id)->get();
    ...
    public function examAttendance()
    {
        ...
        try{
            ...
            $subjects = SmSubject::where('active_status', 1)->where('school_id',Auth::user()->school_id)->get();
            return view('backEnd.examination.exam_attendance', compact('classes', 'subjects'));
        }catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function examAttendanceAeportSearch(Request $request)
    {
      ...
      try{
            ...
            $classes = SmClass::where('active_status', 1)
                        ...
                        ->where('school_id',Auth::user()->school_id)
                        ->get();
            $section_name = SmSection::where('id',$request->section)->first()->section_name;
            $class_name = SmClass::where('id',$request->class)->first()->class_name;
            $subject = SmSubject::where('id',$request->subject)->first();
            $subjects = SmSubject::where('active_status', 1)->where('school_id',Auth::user()->school_id)->get();
             $exam_attendance = SmCourseRegistration::join('sm_students', function($join) use($request){
                $join->on('sm_course_registrations.student_id', '=', 'sm_students.id')
                     ->where('sm_students.class_id','=', $request->class)
                     ->where('sm_students.section_id','=', $request->section);
             })->join('sm_subjects', function($join) use($request){
                $join->on('sm_course_registrations.subject_id', '=', 'sm_subjects.id')
                     ->where('sm_subjects.id','=', $request->subject);
             })->get();

         //dd($exam_attendance);

        return view('backEnd.examination.exam_attendance', compact('exam_attendance','classes','subjects','section_name','class_name','subject'));
        }catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function meritListReportSearch(Request $request)
    {
        ...
        if ($request->method() == 'POST') {
            ...
            $eligible_subjects       = SmAssignSubject::where('class_id', $InputClassId)->where('section_id', $InputSectionId)->where('school_id',Auth::user()->school_id)->get();
            $eligible_students       = SmStudent::where('class_id', $InputClassId)->where('section_id', $InputSectionId)->where('school_id',Auth::user()->school_id)->where('active_status',1)->get();
    ...
    public function markSheetReportSearch(Request $request)
    {
        ...
        try{
            ...
            $subjects = SmAssignSubject::where('class_id', $request->class)->where('section_id', $request->section)->where('school_id',Auth::user()->school_id)->get();
            $all_students = SmStudent::where('class_id', $request->class)->where('section_id', $request->section)->where('school_id',Auth::user()->school_id)->get();

            $marks_registers = SmMarksRegister::where('exam_id', $request->exam)->where('class_id', $request->class)->where('section_id', $request->section)->where('school_id',Auth::user()->school_id)->get();
