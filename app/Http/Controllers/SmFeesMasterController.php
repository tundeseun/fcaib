...

{
    ...
    {
        //dd();
        //dd(Remita::generateRRR('4430731', '10000', 'alabo gift', 'alabo.gift94@gmail.com', '08165940838'));
...
// return $request; 
        ...
        try {
            $section_id=0;
            $classes = DB::table('sm_classes')->where('active_status', 1)->where('school_id', Auth::user()->school_id)->get();
    ...
    //    return $request;
        ...
        $students = $request->student_checked;
        try {
            ...
            if (count($students) > 0) {
                foreach ($students as $student) {
                    ...
                    $notification->message = 'Fees assigned';
            ...
            Toastr::success('Operation successful', 'Success');
            return redirect()->route('fees-assign/1');
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
