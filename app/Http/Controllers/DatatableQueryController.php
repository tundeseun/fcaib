    ...
    public function incomeList(Request $request){
        ...
        $add_incomes = SmAddIncome::with('incomeHeads','paymentMethod')->where('active_status', '=', 1)->where('school_id', Auth::user()->school_id)->get();
            ...
            return Datatables::of($add_incomes)
                ...
                {
                    $emailSmsLogs = SmEmailSmsLog::where('school_id', Auth::user()->school_id)->latest()->get();
                ...
                {
                    $bank_slips = SmBankPaymentSlip::with('studentInfo','feesType')->where('school_id',Auth::user()->school_id)->orderBy('approve_status','asc')->latest()->get();
