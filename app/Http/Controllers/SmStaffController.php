...
class SmStaffController extends Controller
{
    ...
    public function addStaff()
    {
        ...
        try {
            ...
            $marital_status = SmBaseSetup::where('active_status', '=', '1')
            ...
            $genders = SmBaseSetup::where('active_status', '=', '1')
                ...
                return view('backEnd.humanResource.addStaff', compact('roles', 'departments', 'designations', 'marital_status', 'max_staff_no', 'genders'));
        } catch (\Exception $e) {
            return $e->getMessage();
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
    ...
    public function staffStore(Request $request)
    {
        ...
        try {
            ...
            try {
                ...
                try {
                        $compact =  ['name' => $full_name,'email' => $request->email,'password' => '123456'];
                        return view("backEnd.studentInformation.user_credential" ,compact('compact'));
                        
                        send_mail($request->email, $full_name,'Login Details',"backEnd.studentInformation.user_credential" ,$compact);
    ...
    public function editStaff($id)
    {
        ...
        try {
            ...
            $marital_status = SmBaseSetup::where('active_status', '=', '1')->where('base_group_id', '=', '4')->get();
            ...
            return view('backEnd.humanResource.editStaff', compact('editData', 'roles', 'departments', 'designations', 'marital_status', 'max_staff_no', 'genders','custom_fields','custom_filed_values','student'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
