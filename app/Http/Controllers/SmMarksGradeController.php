...
class SmMarksGradeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
         ...
         $is_duplicate_gpa = SmMarksGrade::where('school_id', Auth::user()->school_id)->where('gpa', $request->gpa)->first();
         if ($is_duplicate_gpa) {
    ...
    public function update(Request $request, $id)
    {
        ...
        $is_duplicate_gpa = SmMarksGrade::where('school_id', Auth::user()->school_id)->where('gpa', $request->gpa)->where('id', '!=', $request->id)->first();
        if ($is_duplicate_gpa) {
            Toastr::error('Duplicate GPA found!', 'Failed');
            return redirect()->back()->withErrors($validator)->withInput();
        }
