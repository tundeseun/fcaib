...
class SmTeacherController extends Controller
{
    ...
    {
        try {
            $contentTypes = SmContentType::where('school_id',Auth::user()->school_id)->get();
            if (teacherAccess()) {
            ...
            foreach ($request->available_for as $value) {
                ...
                if ($value == 'student') {
                    ...
                    elseif ( (!is_null($request->class)) &&   ($request->section == '')) {
                        ...
                        $students = SmStudent::select('id', 'user_id')->where('class_id', $request->class)->where('school_id',Auth::user()->school_id)->get();
                        foreach ($students as $student) {
                            $notification = new SmNotification;
                            $notification->user_id = $student->user_id;
                            $notification->role_id = 2;
                        ...
                        $students = SmStudent::select('id','user_id')->where('class_id', $request->class)->where('section_id', $request->section)->where('school_id',Auth::user()->school_id)->get();
                        foreach ($students as $student) {
                            $notification = new SmNotification;
                            $notification->user_id = $student->user_id;
                            $notification->role_id = 2;
            ...
            foreach ($request->available_for as $value) {
                ...
                if ($value == 'student') {
                    if (isset($request->all_classes)) {
                        ...
                        $students = SmStudent::select('id')->where('class_id', $request->class)->where('section_id', $request->section)->where('school_id',Auth::user()->school_id)->get();
                        foreach ($students as $student) {
                            $notification = new SmNotification;
                            $notification->user_id = $student->id;
                            $notification->role_id = 2;
    ...
    public function assignmentList(Request $request)
    {
        ...
        try{
            ...
            if (!teacherAccess()) {
                    ...
                    $uploadContents = SmTeacherUploadContent::where('content_type', 'as')->where('school_id',Auth::user()->school_id)->get();

            } else {

                $uploadContents = SmTeacherUploadContent::where(function ($q) {
                    $q->where('created_by', Auth::user()->id)->orWhere('available_for_admin', 1);
                })->where('content_type', 'as')->where('school_id',Auth::user()->school_id)->get();
            }
    ...
    public function studyMetarialList(Request $request)
    {
        try{
            if (teacherAccess()) {
                $uploadContents = SmTeacherUploadContent::where(function ($q) {
                    $q->where('created_by', Auth::user()->id)->orWhere('available_for_admin', 1);
                })->where('content_type', 'st')->where('school_id',Auth::user()->school_id)->get();
            } else {
    ...
    public function syllabusList(Request $request)
    {
        try{
            if (teacherAccess()) {
                $uploadContents = SmTeacherUploadContent::where(function ($q) {
                    $q->where('created_by', Auth::user()->id)->orWhere('available_for_admin', 1);
                })->where('content_type', 'sy')->where('school_id',Auth::user()->school_id)->get();
            } else {
    ...
    public function otherDownloadList(Request $request)
    {
        ...
        try{
            if (teacherAccess()) {
                $uploadContents = SmTeacherUploadContent::where(function ($q) {
                    $q->where('created_by', Auth::user()->id)->orWhere('available_for_admin', 1);
                })->where('content_type', 'ot')->Where('created_by', Auth::user()->id)->where('school_id',Auth::user()->school_id)->get();
            } else {
