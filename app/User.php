...
class User extends Authenticatable
{
    ...
    public function isHOD(){
        return @$this->staff->department()->count();
    }

    public function booking(){
        return $this->hasOne(SmRoomBooking::class)->where('expires_at', '>', now());
    }

    public function room()
    {
        return $this->belongsToMany(SmRoomList::class, 'sm_room_allocations', 'room_id', 'id');
    }

    public function isGraduate()
    {
        return @$this->student->graduate()->count();
    }
