                        ...
                        <div class="card">
                            ...
                            <div class="p-5">
                                ...
                                <div class="in_single_input">
                                    <i class="ti-user"></i> UTME Number : {{ $applicant_details->utme_number }}
                                    <hr/>
                                </div>

                                <div class="in_single_input">
                                    <i class="ti-email"></i> Email : {{ $applicant_details->email }}
                                     <hr/>
                                </div>

                                <div class="in_login_button text-center mt-2">
                                    <button type="button" onclick="makePayment()" class="btn btn-warning form-control" >
                                        Pay {{@generalSetting()->currency_symbol}}{{number_format($application_cost)}}
                                    </button>
                                </div>
    ...
    <script>         
      function makePayment() {
          ...
          var paymentEngine = RmPaymentEngine.init({
              ...
              customerId: '{{ $applicant_details->utme_number}}',
