...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="offset-lg-3 col-lg-3 text-right mb-20">
                <a href="{{url('/public/backEnd/bulksample/graduands.xlsx')}}">
    ...
    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'upload-graduands-store',
                    ...
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-4" id="class-div">
                                <select class="w-100 niceSelect bb form-control {{ $errors->has('department') ? ' is-invalid' : '' }}" name="department" required>
                                    <option data-display="department *" value="">Department *</option>
                                    @foreach($departments as $department)
                                    <option {{$department->id == request()->id ? 'selected readonly' : ''   }} title="{{$department->class_name}}" value="{{$department->id}}">{{$department->class_name}}</option>
                                    @endforeach
                                </select>
