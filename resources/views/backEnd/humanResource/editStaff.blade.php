                    ...
                    <div class="row mb-30 mt-20">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input form-control" cols="0" rows="4" name="current_address" id="current_address" value="@if(isset($editData)){{$editData->current_address}}@endif"/>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect">
                                        <input class="primary-input form-control" cols="0" rows="4"  name="permanent_address" id="permanent_address" value="@if(isset($editData)){{$editData->permanent_address}}@endif"/>
                                        <span class="focus-border textarea"></span>
