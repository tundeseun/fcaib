                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row  mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input oninput="numberCheck(this)" class="primary-input form-control{{ $errors->has('cost') ? ' is-invalid' : '' }}" type="text" name="cost" 
                                            value="{{isset($dormitory_list)? $dormitory_list->cost: old('cost')}}">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               ...
                                               @if(userPermission(370))
                                                ...
                                                @endif
                                                <a class="dropdown-item" href="{{route('room-lists', [$dormitory_list->id])}}">Rooms</a>
                                                </div>
                                        </div>
                                    </td>
                                </tr>
