                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-30">@if(isset($classById))
                                        @lang('lang.edit')
                                    @else
                                        @lang('lang.add')
                                    @endif
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-30">
                                        <div class="col-lg-12">
                                            <select class="w-100 bb niceSelect form-control {{ $errors->has('hod') ? ' is-invalid' : '' }}" name="hod">
                                                <option data-display="Select Head of Dept. *" value="">Select Head of Dept. *</option>
                                                @foreach($teachers as $teacher)
                                                <option value="{{$teacher->id}}" {{isset($classById) ? ($classById->hod == $teacher->id ? 'selected':''):''}} >{{@$teacher->full_name}}</option>
                                                @endforeach
                                            </select>
                                            @if ($errors->has('hod'))
                            ...
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                @foreach($classes as $class)
                                    <tr>
                                        ...
                                        <td>{{ getStudentsByDept($class->id) }}</td>
                                        <td valign="top">
                                            <div class="dropdown">
