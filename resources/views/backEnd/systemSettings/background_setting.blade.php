                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled For Demo "> 
                                                ...
                                                <a  class="primary-btn small tr-bg" href="#"> @lang('lang.default')</a> 
                                                </span>
                                                @endif
                                            @else
                                            @if(userPermission(489))
                                            <a  class="primary-btn small tr-bg" href="{{route('background_setting-status',@$background_setting->id)}}">@lang('lang.default')</a> 
