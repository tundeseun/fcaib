                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('name') ||  session()->has('message-exist')? ' is-invalid' : '' }}" name="name" id="name">
                                                <option value="">Fee</option>
                                                @foreach($remitaFees as $key => $remitaFee)
                                                        <option value="{{$key}}" {{$key == @$fees_type->remita_service_id ? 'selected':''}} >{{$remitaFee}} </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               ...
                                               @if(userPermission(130))
                                                   @if($fees_type->id != 3 && $fees_type->id != 4 && $fees_type->id != 5)
