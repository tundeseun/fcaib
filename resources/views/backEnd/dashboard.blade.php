    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-lg-12">
                ...
                @else
                    <h3 class="mb-0">@lang('lang.welcome') -  {{@Auth::user()->roles->name}}</h3>
                @endif
                </div>
            </div>
        </div>
            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery" style="background: #B5D56A;">
                    <div class="d-flex justify-content-between" >
                        <div>
                            <h3 class="text-white">@lang('lang.student')</h3>
                            <p class="mb-0 text-white">@lang('lang.total') @lang('lang.students')</p>
                        </div>
                        <h1 class="text-white">
                ...
                <div class="white-box single-summery" style="background: #4886FF;">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <p class="mb-0 text-white">@lang('lang.total') Lecturers</p>
                        </div>
                        <h1 class="text-white">
                            @if(isset($totalStudents))
                            {{count($totalTeachers)}}
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="#" class="d-block">
                <div class="white-box single-summery" style="background: #F6316F;">
                    <div class="d-flex justify-content-between" >
                        <div>
                            <h3 class="text-white">@lang('lang.staffs')</h3>
                            <p class="mb-0 text-white">@lang('lang.total') @lang('lang.staffs')</p>
                        </div>
                        <h1 class="text-white">
