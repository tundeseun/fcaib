...
Route::prefix('parentregistration')->group(function () {
    ...
    Route::get('/registration/{utme_number}', 'ParentRegistrationController@registration')->name('parentregistration/registration');
    ...
    Route::get('/registration-success', 'ParentRegistrationController@registrationSuccess');
    ...
    Route::get('/applicants', 'ParentRegistrationController@applicants')->name('parentregistration-applicants');
    Route::post('/applicants-search', 'ParentRegistrationController@applicantsSearch')->name('parentregistration-applicants-search');
