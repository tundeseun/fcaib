                        ...
                        <div role="tabpanel" class="tab-pane fade  show active" id="studentProfile">
                            ...
                            <h4 class="stu-sub-head mt-20">@lang('lang.guardian') @lang('lang.info')</h4>
                                ...
                                <div class="single-info">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <a href="btn btn-sm btn-primary">View Applicants SSCE Result</a>
                                            <a href="btn btn-sm btn-primary">View Applicants UTME Result</a>
                                            <a href="btn btn-sm btn-primary">View Applicants Guarantors Letter</a>
                                        </div>
                                    </div>
                                </div>
