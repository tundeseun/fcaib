                                            ...
                                            <div class="col-lg-12 mb-3">
                                                <form action="{{ route('chat.invitation.generate','single') }}" method="get" class="bg-white p-4 rounded">
                                                    <p class="text-uppercase mb-0">
                                                        @lang('lang.generate') Lecturer @lang('lang.and') @lang('lang.student') @lang('lang.connection') @lang('lang.for') @lang('lang.old') @lang('lang.class') @lang('lang.&') @lang('lang.subjects')
                                                    </p>
                                                    <br>
